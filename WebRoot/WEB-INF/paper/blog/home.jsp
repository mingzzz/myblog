...
<body>
              	...
              	<div class="row">
					  ...
					  <form action="<c:url value='/home'/>" method="get">
						<div class="input-group">
					      ...
					      <input id="query_input" name="query" type="text" style="height: 30px;border-radius:4px 0px 0px 4px;"  class="form-control" placeholder="喵喵喵喵喵？" value="${query }">
					      <span class="input-group-btn">
					        <button style="border-radius:0px 4px 4px 0px;" class="btn btn-sm btn-default" type="submit">Go!</button>
					      </span>
					    </div>
				      </form>
              		</div>
    ...
    <!-- script references -->
    <script src="<c:url value='/js/frame/jquery-1.10.1.min.js'/>"></script>
